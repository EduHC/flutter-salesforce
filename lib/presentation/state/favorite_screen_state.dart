...
class FavoriteScreenState extends ChangeNotifier {
  static FavoriteScreenState? _instance;

  FavoriteScreenState._();

  factory FavoriteScreenState() {
    _instance ??= FavoriteScreenState._();
    return _instance!;
  }
